...
var fs = require("fs-extra"),
	...
	HdocBinder = require("./binder");

function HdocFactory(hdocHeader, hdocDatum, binderHelpers) {
	...
	this._hdocBinder = new HdocBinder(binderHelpers);
	...
	this._toCreateHdoc = function (resolve, reject) {
		try {
			...
			final = this._hdocBinder.compile(this.data, $.html());
